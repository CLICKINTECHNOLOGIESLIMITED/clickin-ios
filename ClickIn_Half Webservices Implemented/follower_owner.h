...
@interface follower_owner : UIViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate,UIAlertViewDelegate,MODropAlertViewDelegate>
{
    // models references
    ...
    NSMutableArray *followerSection1Array;
    NSMutableArray *followerSection2Array;
